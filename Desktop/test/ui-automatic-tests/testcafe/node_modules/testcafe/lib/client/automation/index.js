...
(function () {
    ...
    var Promise__default = /*#__PURE__*/_interopDefaultLegacy(Promise$e);
    ...
    var DispatchEventAutomation = /** @class */ (function () {
        ...
        DispatchEventAutomation._getEventCtorFromNativeMethods = function (eventCtor) {
            var ctor = nativeMethods$d['Window' + eventCtor] || DispatchEventAutomation._getEventCtorFromWindow(eventCtor);
            return ctor;
        };
    ...
    ***************************************************************************** */
    ...
    var findDocument = hammerhead__default["default"].utils.dom.findDocument;
    var find = hammerhead__default["default"].utils.dom.find;
    ...
    var isElementNode = hammerhead__default["default"].utils.dom.isElementNode;
    ...
    var isImgElement = hammerhead__default["default"].utils.dom.isImgElement;
    ...
    var isMapElement = hammerhead__default["default"].utils.dom.isMapElement;
    var isBodyElement = hammerhead__default["default"].utils.dom.isBodyElement;
    ...
    var getMapContainer = hammerhead__default["default"].utils.dom.getMapContainer;
    var getTagName = hammerhead__default["default"].utils.dom.getTagName;
    var closest = hammerhead__default["default"].utils.dom.closest;
    var getParents = hammerhead__default["default"].utils.dom.getParents;
    var findParent = hammerhead__default["default"].utils.dom.findParent;
    ...
    function findIframeByWindow(iframeWindow) {
        ...
        for (var i = 0; i < iframes.length; i++) {
            if (nativeMethods$c.contentWindowGetter.call(iframes[i]) === iframeWindow)
                return iframes[i];
        }
        return null;
    }
    ...
    function getNodeText(el) {
        return nativeMethods$c.nodeTextContentGetter.call(el);
    }
    ...
    var styleUtils$6 = hammerhead__default["default"].utils.style;
    ...
    var getElementPadding = hammerhead__default["default"].utils.style.getElementPadding;
    ...
    var getWidth = hammerhead__default["default"].utils.style.getWidth;
    var getHeight = hammerhead__default["default"].utils.style.getHeight;
    ...
    var getScrollLeft = hammerhead__default["default"].utils.style.getScrollLeft;
    var getScrollTop = hammerhead__default["default"].utils.style.getScrollTop;
    var setScrollLeft = hammerhead__default["default"].utils.style.setScrollLeft;
    var setScrollTop = hammerhead__default["default"].utils.style.setScrollTop;
    var get = hammerhead__default["default"].utils.style.get;
    var getBordersWidthFloat = hammerhead__default["default"].utils.style.getBordersWidthFloat;
    var getElementPaddingFloat = hammerhead__default["default"].utils.style.getElementPaddingFloat;
    function getWindowDimensions(window) {
        return new BoundaryValues(0, getWidth(window), getHeight(window), 0);
    }
    function isFixedElement(node) {
        return isElementNode(node) && styleUtils$6.get(node, 'position') === 'fixed';
    }
    function isStickyElement(node) {
        return isElementNode(node) && styleUtils$6.get(node, 'position') === 'sticky';
    }
    ...
    var htmlUtils$1 = hammerhead__default["default"].utils.html;
    ...
    function stringifyElement(element) {
        if (!element)
            return '';
        var emptyElement = nativeMethods$b.cloneNode.call(element);
        var outerHtml = htmlUtils$1.cleanUpHtml(nativeMethods$b.elementOuterHTMLGetter.call(emptyElement));
        var text = truncateString(nativeMethods$b.nodeTextContentGetter.call(element), MAX_TEXT_CONTENT_LENGTH);
        var children = nativeMethods$b.elementChildrenGetter.call(element);
        if (nativeMethods$b.htmlCollectionLengthGetter.call(children) > 0)
    ...
    function getElementFromPoint$2(_a) {
        var x = _a.x, y = _a.y;
        // @ts-ignore
    ...
    var positionUtils$7 = testCafeCore__default["default"].positionUtils;
    function getElementFromPoint$1(point, underTopShadowUIElement) {
        ...
        return testCafeUI__default["default"].hide(underTopShadowUIElement)
            .then(function () {
            var topElement = positionUtils$7.getElementFromPoint(point);
            return testCafeUI__default["default"].show(underTopShadowUIElement)
    ...
    function findElementOrNonEmptyChildFromPoint(point, element) {
        return hammerhead.Promise.resolve(getElementFromPoint$2(point))
    ...
    var Promise$d = hammerhead__default["default"].Promise;
    var nativeMethods$a = hammerhead__default["default"].nativeMethods;
    function delay$5 (ms) {
        return new Promise$d(function (resolve) { return nativeMethods$a.setTimeout.call(window, resolve, ms); });
    }
    ...
    hammerhead__default["default"].Promise;
    hammerhead__default["default"].nativeMethods;
    hammerhead__default["default"].eventSandbox.listeners;
    // Imported form the hammerhead
    hammerhead__default["default"].utils.event.BUTTON;
    var BUTTONS_PARAMETER = hammerhead__default["default"].utils.event.BUTTONS_PARAMETER;
    hammerhead__default["default"].utils.event.DOM_EVENTS;
    hammerhead__default["default"].utils.event.WHICH_PARAMETER;
    hammerhead__default["default"].utils.event.preventDefault;
    ...
    var Promise$c = hammerhead__default["default"].Promise;
        ...
        return new Promise$c(function (resolve) {
            function onMessage(e) {
                if (e.message.cmd === responseCmd) {
                    messageSandbox$4.off(messageSandbox$4.SERVICE_MSG_RECEIVED_EVENT, onMessage);
                    resolve(e.message);
                }
            }
            messageSandbox$4.on(messageSandbox$4.SERVICE_MSG_RECEIVED_EVENT, onMessage);
            messageSandbox$4.sendServiceMsg(msg, receiverWindow);
        });
    }
    ...
    var listeners$3 = hammerhead.eventSandbox.listeners;
    var ScrollController = /** @class */ (function () {
        ...
        ScrollController.prototype.init = function () {
            ...
            listeners$3.initElementListening(window, ['scroll']);
            listeners$3.addFirstInternalEventBeforeListener(window, ['scroll'], function () {
                var args = [];
                for (var _i = 0; _i < arguments.length; _i++) {
                    args[_i] = arguments[_i];
                }
        ...
        ScrollController.prototype.handleScrollEvents = function (el, handler) {
            ...
            if (isShadowElement(el)) {
                listeners$3.initElementListening(el, ['scroll']);
                listeners$3.addFirstInternalEventBeforeListener(el, ['scroll'], function () {
                    var args = [];
                    for (var _i = 0; _i < arguments.length; _i++) {
                        args[_i] = arguments[_i];
                    }
                    _this._internalListener.apply(_this, args);
                    listeners$3.cancelElementListening(el);
                });
            }
        };
    ...
    var ScrollAutomation = /** @class */ (function () {
        ...
        ScrollAutomation.prototype._isTargetElementObscuredInPoint = function (point) {
            var elementInPoint = getElementFromPoint$2(point);
            if (!elementInPoint)
                return false;
    ...
    var eventSimulator$e = hammerhead__default["default"].eventSandbox.eventSimulator;
    var extend$4 = hammerhead__default["default"].utils.extend;
    var nativeMethods$9 = hammerhead__default["default"].nativeMethods;
    var MoveBehaviour = /** @class */ (function () {
        ...
        MoveBehaviour.leaveElement = function (currentElement, prevElement, commonAncestor, options) {
            eventSimulator$e.mouseout(prevElement, extend$4({ relatedTarget: currentElement }, options));
            var currentParent = prevElement;
            while (currentParent && currentParent !== commonAncestor) {
                eventSimulator$e.mouseleave(currentParent, extend$4({ relatedTarget: currentElement }, options));
                currentParent = nativeMethods$9.nodeParentNodeGetter.call(currentParent);
            }
        };
        MoveBehaviour.enterElement = function (currentElement, prevElement, commonAncestor, options) {
            eventSimulator$e.mouseover(currentElement, extend$4({ relatedTarget: prevElement }, options));
            ...
            for (var i = mouseenterElements.length - 1; i > -1; i--)
                eventSimulator$e.mouseenter(mouseenterElements[i], extend$4({ relatedTarget: prevElement }, options));
        };
        MoveBehaviour.move = function (moveEvent, element, options) {
            eventSimulator$e[moveEvent](element, options);
        };
    ...
    var DragAndDropBehavior = /** @class */ (function () {
        ...
        DragAndDropBehavior.dragAndDrop = function (dragElement, currentElement, prevElement, options) {
            eventSimulator$e.drag(dragElement, options);
            ...
            if (currentElementChanged) {
                if (testCafeCore.domUtils.isElementInDocument(currentElement)) {
                    ...
                    eventSimulator$e.dragenter(currentElement, options);
                }
                if (prevElement) {
                    options.relatedTarget = currentElement;
                    eventSimulator$e.dragleave(prevElement, options);
                }
            }
            return !eventSimulator$e.dragover(currentElement, options);
        };
        return DragAndDropBehavior;
    }());

    var eventSimulator$d = hammerhead__default["default"].eventSandbox.eventSimulator;
    ...
    var MoveEventSequence = /** @class */ (function (_super) {
        ...
        MoveEventSequence.prototype.teardown = function (currentElement, eventOptions, prevElement) {
            ...
            if (this._needEmulateMoveEvent() && testCafeCore.domUtils.isElementInDocument(currentElement) && currentElement !== prevElement)
                eventSimulator$d[this.moveEvent](currentElement, eventOptions);
        };
    ...
    var eventSimulator$c = hammerhead__default["default"].eventSandbox.eventSimulator;
    var DragAndDropFirstMoveEventSequence = /** @class */ (function (_super) {
        ...
        DragAndDropFirstMoveEventSequence.prototype.dragAndDrop = function (dragElement, currentElement, prevElement, options, dragDataStore) {
            var dragAllowed = eventSimulator$c.dragstart(dragElement, options);
    ...
    var MoveAutomation = /** @class */ (function () {
        ...
        MoveAutomation.prototype._moveToCurrentFrame = function (endPoint, nativeAutomationMove) {
            ...
            return hammerhead.Promise.resolve()
                ...
                return sendRequestToFrame(msg, MOVE_RESPONSE_CMD$1, activeWindow);
            })
    ...
    var cursorUI = !isIframeWindow(window) ? testCafeUI__default["default"].cursorUI : testCafeUI__default["default"].iframeCursorUI;
    var cursor = new Cursor(window.top, cursorUI);

    var positionUtils$6 = testCafeCore__default["default"].positionUtils, domUtils$e = testCafeCore__default["default"].domUtils, eventUtils$5 = testCafeCore__default["default"].eventUtils;
    function ensureMouseEventAfterScroll(currentElement, element, wasScrolled) {
        return __awaiter(this, void 0, hammerhead__default["default"].Promise, function () {
            var elementUnderCursorContainsTarget, prevElement, commonAncestor, clientPosition, devicePoint, options;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        elementUnderCursorContainsTarget = !!currentElement && domUtils$e.contains(element, currentElement);
                        if (!elementUnderCursorContainsTarget || !wasScrolled)
                            return [2 /*return*/];
                        prevElement = lastHoveredElementHolder.get();
                        commonAncestor = domUtils$e.getCommonAncestor(currentElement, prevElement);
                        return [4 /*yield*/, positionUtils$6.getClientPosition(currentElement)];
                    case 1:
                    ...
                    case 2:
                        ...
                        options = {
                            ...
                            shift: false,
                            meta: false,
                            buttons: eventUtils$5.BUTTONS_PARAMETER.leftButton,
                        };
                        MoveBehaviour.leaveElement(currentElement, prevElement, commonAncestor, options);
                        MoveBehaviour.enterElement(currentElement, prevElement, commonAncestor, options);
                        lastHoveredElementHolder.set(currentElement);
    ...
    var utils = hammerhead__default["default"].utils, eventSandbox$1 = hammerhead__default["default"].eventSandbox, nativeMethods$8 = hammerhead__default["default"].nativeMethods;
    var messageSandbox$3 = eventSandbox$1.message;
    ...
    messageSandbox$3.on(messageSandbox$3.SERVICE_MSG_RECEIVED_EVENT, function (e) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var CDPEventDescriptor = /** @class */ (function () {
        ...
        CDPEventDescriptor._isNonCharKeyModifier = function (modifiers) {
            ...
            return nativeMethods$8.arrayIndexOf.call(nonCharModifiers, modifiers) > -1;
        };
    ...
    var TOUCH_MODE = hammerhead__default["default"].utils.featureDetection.isTouchDevice;
    ...
    var VisibleElementAutomation = /** @class */ (function (_super) {
        ...
        VisibleElementAutomation.prototype._getElementForEvent = function (eventArgs) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, getElementFromPoint(eventArgs.point, this.window, expectedElement)];
                });
            });
        };
        ...
        VisibleElementAutomation.prototype._scrollToElement = function () {
            ...
            return scrollAutomation.run()
                ...
                return delay$5(_this.automationSettings.mouseActionStepDelay);
            })
                .then(function () { return getElementFromPoint(_this.cursor.getPosition(), _this.window); })
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            clientPoint = _a.sent();
                            return [4 /*yield*/, getElementFromPoint(clientPoint, this.window, expectedElement)];
                        case 4:
                            element = _a.sent();
    ...
    var Promise$b = hammerhead__default["default"].Promise;
    ...
    var Promise$a = hammerhead__default["default"].Promise;
    var nativeMethods$7 = hammerhead__default["default"].nativeMethods;
    var browserUtils$a = hammerhead__default["default"].utils.browser;
    var focusBlurSandbox$4 = hammerhead__default["default"].eventSandbox.focusBlur;
    var contentEditable$6 = testCafeCore__default["default"].contentEditable;
    var textSelection$5 = testCafeCore__default["default"].textSelection;
    var domUtils$d = testCafeCore__default["default"].domUtils;
    ...
    messageSandbox$2.on(messageSandbox$2.SERVICE_MSG_RECEIVED_EVENT, function (e) {
        if (e.message.cmd === GET_IFRAME_REQUEST_CMD) {
            var iframeElement = domUtils$d.findIframeByWindow(e.source);
            focusBlurSandbox$4.focus(iframeElement, function () {
                messageSandbox$2.sendServiceMsg({ cmd: GET_IFRAME_RESPONSE_CMD }, e.source);
            }, false);
        }
    });
    function setCaretPosition(element, caretPos) {
        var isTextEditable = domUtils$d.isTextEditableElement(element);
        var isContentEditable = domUtils$d.isContentEditableElement(element);
        if (isTextEditable || isContentEditable) {
            if (isContentEditable && isNaN(parseInt(caretPos, 10)))
                textSelection$5.setCursorToLastVisiblePosition(element);
            else {
                var position = isNaN(parseInt(caretPos, 10)) ? domUtils$d.getElementValue(element).length : caretPos;
                textSelection$5.select(element, position, position);
            }
        }
        else {
            ...
            var contentEditableParent = contentEditable$6.findContentEditableParent(element);
            if (contentEditableParent)
                textSelection$5.setCursorToLastVisiblePosition(contentEditable$6.findContentEditableParent(contentEditableParent));
        }
    }
    function focusAndSetSelection(element, simulateFocus, caretPos) {
        var _this = this;
        return new Promise$a(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        activeElement = domUtils$d.getActiveElement();
                        isTextEditable = domUtils$d.isTextEditableElement(element);
                        labelWithForAttr = domUtils$d.closest(element, 'label[for]');
                        isElementFocusable = domUtils$d.isElementFocusable(element);
                        shouldFocusByRelatedElement = !isElementFocusable && labelWithForAttr;
                        isContentEditable = domUtils$d.isContentEditableElement(element);
                        elementForFocus = isContentEditable ? contentEditable$6.findContentEditableParent(element) : element;
                        ...
                        if (simulateFocus && browserUtils$a.isWebKit && isTextEditable)
                            textSelection$5.select(element, 0, 0);
                        ...
                        if (!isElementFocusable && !isContentEditable) {
                            curDocument = domUtils$d.findDocument(elementForFocus);
                            curActiveElement = nativeMethods$7.documentActiveElementGetter.call(curDocument);
                            isActiveElementBody = domUtils$d.isBodyElement(curActiveElement);
                            focusableParent = domUtils$d.isBodyElement(elementForFocus) ?
                                elementForFocus : domUtils$d.getFocusableParent(elementForFocus);
                            elementChildOfActiveElement = curActiveElement && !isActiveElementBody &&
                                domUtils$d.containsElement(curActiveElement, elementForFocus);
                            if (elementChildOfActiveElement || isActiveElementBody && domUtils$d.isBodyElement(focusableParent)) {
                                resolve();
                                return [2 /*return*/];
                            }
                        ...
                        focusBlurSandbox$4.focus(elementForFocus, function () {
                            // NOTE: if a different element was focused in the focus event handler, we should not set selection
                            if (simulateFocus && !isContentEditable && element !== domUtils$d.getActiveElement()) {
                                resolve();
                                return;
                            }
                            ...
                            if (!simulateFocus && domUtils$d.getActiveElement() !== activeElement)
                                focusBlurSandbox$4.focus(activeElement, resolve, true, true);
                            else
                                resolve();
    ...
    function getElementBoundToLabel(element) {
        var labelWithForAttr = domUtils$d.closest(element, 'label[for]');
        var control = labelWithForAttr && (labelWithForAttr.control || document.getElementById(labelWithForAttr.htmlFor));
        var isControlVisible = control && styleUtils$5.isElementVisible(control);
        return isControlVisible ? control : null;
    }
    function focusByLabel(label) {
        if (domUtils$d.isElementFocusable(label))
            focusBlurSandbox$4.focus(label, testCafeCore__default["default"].noop, false, true);
        else
            focusByRelatedElement(label);
    }
    function focusByRelatedElement(element) {
        var elementForFocus = getElementBoundToLabel(element);
        if (!elementForFocus || domUtils$d.getActiveElement() === elementForFocus)
            return;
        focusBlurSandbox$4.focus(elementForFocus, testCafeCore__default["default"].noop, false, true);
    }

    var browserUtils$9 = hammerhead__default["default"].utils.browser;
    var eventSimulator$b = hammerhead__default["default"].eventSandbox.eventSimulator;
    var listeners$2 = hammerhead__default["default"].eventSandbox.listeners;
    var nativeMethods$6 = hammerhead__default["default"].nativeMethods;
    var domUtils$c = testCafeCore__default["default"].domUtils;
    var styleUtils$4 = testCafeCore__default["default"].styleUtils;
    var selectController$1 = testCafeCore__default["default"].selectController;
    var selectElementUI$1 = testCafeUI__default["default"].selectElement;
    var ElementClickCommand = /** @class */ (function () {
        ...
        ElementClickCommand.prototype.run = function () {
            if (this.eventState.clickElement)
                eventSimulator$b.click(this.eventState.clickElement, this.eventArgs.options);
            if (!domUtils$c.isElementFocusable(this.eventArgs.element))
    ...
    var SelectElementClickCommand = /** @class */ (function (_super) {
        ...
        SelectElementClickCommand.prototype._toggleSelectOptionList = function () {
            ...
            var isSelectWithDropDown = styleUtils$4.getSelectElementSize(element) === 1;
            if (isSelectWithDropDown && this.eventState.simulateDefaultBehavior !== false) {
                if (selectController$1.isOptionListExpanded(element))
                    selectElementUI$1.collapseOptionList();
                else
                    selectElementUI$1.expandOptionList(element);
            }
        };
    ...
    var LabelledCheckboxElementClickCommand = /** @class */ (function (_super) {
        ...
        LabelledCheckboxElementClickCommand.prototype.run = function () {
            ...
            if (browserUtils$9.isChrome && !changed && !this.checkbox.disabled && !this._isClickableElementInsideLabel(this.targetElement))
        ...
        LabelledCheckboxElementClickCommand.prototype._ensureCheckboxStateChanged = function () {
            ...
            eventSimulator$b.change(this.checkbox);
        };
        LabelledCheckboxElementClickCommand.prototype._isClickableElementInsideLabel = function (element) {
            var isClickableLink = domUtils$c.isAnchorElement(element) && element.getAttribute('href');
            var isButton = domUtils$c.isButtonElement(element);
    ...
    function createClickCommand (eventState, eventArgs) {
        ...
        var isSelectElement = domUtils$c.isSelectElement(eventArgs.element);
        var isOptionElement = domUtils$c.isOptionElement(eventArgs.element);
        var isLabelElement = domUtils$c.isLabelElement(eventArgs.element) && elementBoundToLabel;
        var isLabelledCheckbox = elementBoundToLabel && domUtils$c.isCheckboxElement(elementBoundToLabel);
        if (isSelectElement)
    ...
    // @ts-ignore
    var Promise$9 = hammerhead__default["default"].Promise;
    var browserUtils$8 = hammerhead__default["default"].utils.browser;
    var featureDetection$5 = hammerhead__default["default"].utils.featureDetection;
    var eventSimulator$a = hammerhead__default["default"].eventSandbox.eventSimulator;
    var listeners$1 = hammerhead__default["default"].eventSandbox.listeners;
    var domUtils$b = testCafeCore__default["default"].domUtils;
    var eventUtils$4 = testCafeCore__default["default"].eventUtils;
    var arrayUtils$1 = testCafeCore__default["default"].arrayUtils;
    function _getElementForClick(mouseDownElement, topElement, mouseDownElementParentNodes) {
        var topElementParentNodes = domUtils$b.getParents(topElement);
        var areElementsSame = domUtils$b.isTheSameNode(topElement, mouseDownElement);
        // NOTE: Mozilla Firefox always skips click, if an element under cursor has been changed after mousedown.
        if (browserUtils$8.isFirefox)
            return areElementsSame ? mouseDownElement : null;
        if (!areElementsSame) {
            // @ts-ignore
            if (mouseDownElement.contains(topElement) && !domUtils$b.isEditableFormElement(topElement))
            ...
            return arrayUtils$1.getCommonElement(topElementParentNodes, mouseDownElementParentNodes);
        }
        ...
        return arrayUtils$1.equals(mouseDownElementParentNodes, topElementParentNodes) ? mouseDownElement : null;
    }
    var MouseClickStrategy = /** @class */ (function () {
        ...
        MouseClickStrategy.prototype.mousedown = function (eventArgs) {
            var _this = this;
            this.targetElementParentNodes = domUtils$b.getParents(eventArgs.element);
            this.mouseDownElement = eventArgs.element;
            this._raiseTouchEvents(eventArgs);
            var activeElement = domUtils$b.getActiveElement();
            ...
            var needCloseSelectDropDown = browserUtils$8.isWebKit && domUtils$b.isSelectElement(this.mouseDownElement);
            if (needCloseSelectDropDown)
                this._bindMousedownHandler();
            this._bindBlurHandler(activeElement);
            if (!this._isTouchEventWasCancelled())
                this.eventState.simulateDefaultBehavior = eventSimulator$a.mousedown(eventArgs.element, eventArgs.options);
        ...
        MouseClickStrategy.prototype.mouseup = function (element, eventArgs) {
            ...
            if (!this._isTouchEventWasCancelled())
                eventSimulator$a.mouseup(element, eventArgs.options);
        ...
        MouseClickStrategy.prototype._bindMousedownHandler = function () {
            ...
            var onmousedown = function (e) {
                ...
                eventUtils$4.preventDefault(e);
                eventUtils$4.unbind(_this.element, 'mousedown', onmousedown);
            };
            eventUtils$4.bind(this.element, 'mousedown', onmousedown);
        };
        MouseClickStrategy.prototype._bindBlurHandler = function (element) {
            var _this = this;
            var onblur = function () {
                _this.eventState.blurRaised = true;
                eventUtils$4.unbind(element, 'blur', onblur, true);
            };
            eventUtils$4.bind(element, 'blur', onblur, true);
        };
        MouseClickStrategy.prototype._ensureActiveElementBlur = function (element) {
            ...
            return new Promise$9(function (resolve) {
                var simulateBlur = domUtils$b.getActiveElement() !== element && !_this.eventState.blurRaised;
                if (!simulateBlur) {
                    resolve();
                    return;
                }
                eventSimulator$a.blur(element);
                resolve();
            });
        };
        MouseClickStrategy.prototype._focus = function (eventArgs) {
            ...
            var elementForFocus = domUtils$b.isContentEditableElement(this.element) ? this.element : eventArgs.element;
        ...
        MouseClickStrategy.prototype._raiseTouchEvents = function (eventArgs) {
            if (featureDetection$5.isTouchDevice) {
                this.eventState.touchStartCancelled = !eventSimulator$a.touchstart(eventArgs.element, eventArgs.options);
                this.eventState.touchEndCancelled = !eventSimulator$a.touchend(eventArgs.element, eventArgs.options);
            }
        };
    ...
    var ClickAutomation = /** @class */ (function (_super) {
        ...
        ClickAutomation.prototype.run = function (useStrictElementCheck) {
            ...
            return this
                ...
                return hammerhead.Promise.all([delay$5(_this.automationSettings.mouseActionStepDelay), _this.cursor
                        .leftButtonDown()
    ...
    var eventSimulator$9 = hammerhead__default["default"].eventSandbox.eventSimulator;
    var messageSandbox$1 = hammerhead__default["default"].eventSandbox.message;
    var positionUtils$5 = testCafeCore__default["default"].positionUtils;
    ...
    function onMoveToIframeRequest(e, dispatchNativeAutomationEventFn) {
        ...
        var iframe = domUtils$a.findIframeByWindow(iframeWin);
        var iframeBorders = styleUtils$3.getBordersWidth(iframe);
        var iframePadding = styleUtils$3.getElementPadding(iframe);
        var iframeRectangle = positionUtils$5.getIframeClientCoordinates(iframe);
        var iframePointRelativeToParent = positionUtils$5.getIframePointRelativeToParentFrame(iframePoint, iframeWin);
        var cursorPosition = cursor.getPosition();
        var intersectionPoint = positionUtils$5.isInRectangle(cursorPosition, iframeRectangle) ? cursorPosition :
    ...
    function onMoveOutRequest(e) {
        ...
        if (!e.message.iframeUnderCursor) {
            ...
            if (element) {
                eventSimulator$9.mouseout(element, { clientX: clientX, clientY: clientY, relatedTarget: null });
                eventSimulator$9.mouseleave(element, { clientX: clientX, clientY: clientY, relatedTarget: null });
            }
    ...
    messageSandbox$1.on(messageSandbox$1.SERVICE_MSG_RECEIVED_EVENT, function (e) {
        if (e.message.cmd === MOVE_REQUEST_CMD) {
            if (e.source.parent === window) {
                ...
                hammerhead__default["default"].on(hammerhead__default["default"].EVENTS.beforeUnload, function () { return messageSandbox$1.sendServiceMsg({ cmd: MOVE_RESPONSE_CMD }, e.source); });
                onMoveOutRequest(e);
            }
        }
    });

    var Promise$8 = hammerhead__default["default"].Promise;
    var browserUtils$7 = hammerhead__default["default"].utils.browser;
    var featureDetection$4 = hammerhead__default["default"].utils.featureDetection;
    var eventSimulator$8 = hammerhead__default["default"].eventSandbox.eventSimulator;
    var focusBlurSandbox$3 = hammerhead__default["default"].eventSandbox.focusBlur;
    var nativeMethods$5 = hammerhead__default["default"].nativeMethods;
    var domUtils$9 = testCafeCore__default["default"].domUtils;
    var styleUtils$2 = testCafeCore__default["default"].styleUtils;
    var delay$4 = testCafeCore__default["default"].delay;
    var selectController = testCafeCore__default["default"].selectController;
    var selectElementUI = testCafeUI__default["default"].selectElement;
    var FOCUS_DELAY = featureDetection$4.isTouchDevice ? 0 : 160;
    var SelectChildClickAutomation = /** @class */ (function () {
        function SelectChildClickAutomation(element, clickOptions) {
            ...
            this.parentSelect = domUtils$9.getSelectParent(this.element);
            ...
            if (this.parentSelect) {
                var isOption = domUtils$9.isOptionElement(this.element);
                var selectedIndex = this.parentSelect.selectedIndex;
                this.childIndex = isOption ? domUtils$9.getElementIndexInParent(this.parentSelect, this.element) :
                    domUtils$9.getElementIndexInParent(this.parentSelect, this.element);
                var parent_1 = nativeMethods$5.nodeParentNodeGetter.call(this.element);
                var parentOptGroup = domUtils$9.isOptionGroupElement(parent_1) ? parent_1 : null;
        ...
        SelectChildClickAutomation.prototype._calculateEventArguments = function () {
            var childElement = this.optionListExpanded ? selectController.getEmulatedChildElement(this.element) : this.element;
            return {
                options: this.modifiers,
        ...
        SelectChildClickAutomation.prototype._mousedown = function () {
            var _this = this;
            if (browserUtils$7.isFirefox) {
                eventSimulator$8.mousedown(this.eventsArgs.element, this.eventsArgs.options);
            ...
            return this
                ._focus()
                .then(function () { return delay$4(FOCUS_DELAY); })
                .then(function () {
                eventSimulator$8.mousedown(_this.eventsArgs.element, _this.eventsArgs.options);
        ...
        SelectChildClickAutomation.prototype._focus = function () {
            ...
            return new Promise$8(function (resolve) {
                focusBlurSandbox$3.focus(_this.parentSelect, resolve, false, true);
            });
        };
        SelectChildClickAutomation.prototype._mouseup = function () {
            eventSimulator$8.mouseup(this.eventsArgs.element, this.eventsArgs.options);
            var simulateInputEventOnValueChange = browserUtils$7.isFirefox || browserUtils$7.isSafari ||
                browserUtils$7.isChrome && browserUtils$7.version >= 53;
            if (simulateInputEventOnValueChange && this.clickCausesChange)
                eventSimulator$8.input(this.parentSelect);
            if (simulateInputEventOnValueChange && this.clickCausesChange)
                eventSimulator$8.change(this.parentSelect);
            return Promise$8.resolve();
        };
        SelectChildClickAutomation.prototype._click = function () {
            eventSimulator$8.click(this.eventsArgs.element, this.eventsArgs.options);
        };
        SelectChildClickAutomation.prototype.run = function () {
            ...
            if (styleUtils$2.getSelectElementSize(this.parentSelect) <= 1) {
                return this
                    ._move(moveArguments)
    ...
    var featureDetection$3 = hammerhead__default["default"].utils.featureDetection;
    var eventSimulator$7 = hammerhead__default["default"].eventSandbox.eventSimulator;
    var delay$3 = testCafeCore__default["default"].delay;
    ...
    var htmlUtils = hammerhead__default["default"].utils.html;
    var urlUtils = hammerhead__default["default"].utils.url;
    var DataTransfer = hammerhead__default["default"].eventSandbox.DataTransfer;
    var DragDataStore = hammerhead__default["default"].eventSandbox.DragDataStore;
    var eventUtils$3 = testCafeCore__default["default"].eventUtils;
    var domUtils$8 = testCafeCore__default["default"].domUtils;
    // Utils
    ...
    var DragMoveAutomation = /** @class */ (function (_super) {
        ...
        DragMoveAutomation.prototype.run = function () {
            ...
            return getElementFromPoint(this.cursor.getPosition())
                ...
                if (draggable && featureDetection$2.hasDataTransfer && !_this.skipDefaultDragBehavior) {
                    ...
                    var isLink = domUtils$8.isAnchorElement(_this.dragElement);
                    if (isLink || domUtils$8.isImgElement(_this.dragElement)) {
    ...
    var Promise$7 = hammerhead__default["default"].Promise;
    var extend$3 = hammerhead__default["default"].utils.extend;
    var featureDetection$1 = hammerhead__default["default"].utils.featureDetection;
    var eventSimulator$6 = hammerhead__default["default"].eventSandbox.eventSimulator;
    var focusBlurSandbox$2 = hammerhead__default["default"].eventSandbox.focusBlur;
    var DragAutomationBase = /** @class */ (function (_super) {
        ...
        function DragAutomationBase(element, mouseOptions) {
            ...
            _this.downEvent = featureDetection$1.isTouchDevice ? 'touchstart' : 'mousedown';
            _this.upEvent = featureDetection$1.isTouchDevice ? 'touchend' : 'mouseup';
        ...
        DragAutomationBase.prototype._mousedown = function (eventArgs) {
            ...
            return cursor
                .leftButtonDown()
                .then(function () {
                _this.simulateDefaultBehavior = eventSimulator$6[_this.downEvent](eventArgs.element, eventArgs.options);
        ...
        DragAutomationBase.prototype._mouseup = function (draggedElement) {
            var _this = this;
            return cursor
                .buttonUp()
                .then(function () {
                ...
                return getElementFromPoint(point)
                    ...
                    if (_this.dragAndDropState.enabled) {
                        ...
                        if (_this.dragAndDropState.dropAllowed)
                            eventSimulator$6.drop(topElement, options);
                        eventSimulator$6.dragend(_this.dragAndDropState.element, options);
                        _this.dragAndDropState.dataStore.setProtectedMode();
                    }
                    else
                        eventSimulator$6[_this.upEvent](topElement, options);
                    return getElementFromPoint(point);
                })
                    .then(function (element) {
                    //B231323
                    if (topElement && element === topElement && !_this.dragAndDropState.enabled && element === draggedElement)
                        eventSimulator$6.click(topElement, options);
                });
            });
        };
        DragAutomationBase.prototype.run = function (useStrictElementCheck) {
            ...
            return this
                ...
                .then(function () { return _this._mouseup(eventArgs.element); });
        };
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            startPoint = _a.sent();
                            maxX = styleUtils$1.getWidth(document);
                            maxY = styleUtils$1.getHeight(document);
                            endPoint = {
    ...
    var positionUtils$4 = testCafeCore__default["default"].positionUtils;
    ...
    var browserUtils$6 = hammerhead__default["default"].utils.browser;
    var eventSandbox = hammerhead__default["default"].sandbox.event;
    var eventSimulator$5 = hammerhead__default["default"].eventSandbox.eventSimulator;
    ...
    var domUtils$7 = testCafeCore__default["default"].domUtils;
    var contentEditable$5 = testCafeCore__default["default"].contentEditable;
    var textSelection$4 = testCafeCore__default["default"].textSelection;
    var WHITE_SPACES_RE = / /g;
    function _getSelectionInElement(element) {
        var currentSelection = textSelection$4.getSelectionByElement(element);
        var isInverseSelection = textSelection$4.hasInverseSelectionContentEditable(element);
        if (textSelection$4.hasElementContainsSelection(element))
            return contentEditable$5.getSelection(element, currentSelection, isInverseSelection);
        ...
        return {
            startPos: contentEditable$5.calculateNodeAndOffsetByPosition(element, 0),
            endPos: contentEditable$5.calculateNodeAndOffsetByPosition(element, 0),
        };
    }
    function _updateSelectionAfterDeletionContent(element, selection) {
        var startNode = selection.startPos.node;
        var startParent = nativeMethods$3.nodeParentNodeGetter.call(startNode);
        var hasStartParent = startParent && startNode.parentElement;
        var browserRequiresSelectionUpdating = browserUtils$6.isChrome && browserUtils$6.version < 58 || browserUtils$6.isSafari;
        if (browserRequiresSelectionUpdating || !hasStartParent || !domUtils$7.isElementContainsNode(element, startNode)) {
            ...
            if (textSelection$4.hasInverseSelectionContentEditable(element)) {
                selection = {
    ...
    function _typeTextInElementNode(elementNode, text, offset) {
        ...
        var parent = nativeMethods$3.nodeParentNodeGetter.call(elementNode);
        if (domUtils$7.getTagName(elementNode) === 'br')
            parent.insertBefore(nodeForTyping, elementNode);
        else if (offset > 0) {
            var childNodes = nativeMethods$3.nodeChildNodesGetter.call(elementNode);
            elementNode.insertBefore(nodeForTyping, childNodes[offset]);
        }
        else
            elementNode.appendChild(nodeForTyping);
        textSelection$4.selectByNodesAndOffsets(selectPosition, selectPosition);
    }
    ...
    function _excludeInvisibleSymbolsFromSelection(selection) {
        ...
        var startOffset = selection.startPos.offset;
        var endOffset = selection.endPos.offset;
        var firstNonWhitespaceSymbolIndex = contentEditable$5.getFirstNonWhitespaceSymbolIndex(startNode.nodeValue);
        var lastNonWhitespaceSymbolIndex = contentEditable$5.getLastNonWhitespaceSymbolIndex(startNode.nodeValue);
    ...
    function simulateBeforeInput(element, text, needSimulate) {
        if (needSimulate)
            return eventSimulator$5.beforeInput(element, text);
        return true;
    }
    ...
    function simulateTextInput(element, text) {
        ...
        var isInputEventRequired = browserUtils$6.isFirefox || eventSimulator$5.textInput(element, text) || forceInputInSafari;
        if (browserUtils$6.isSafari) {
    ...
    function _typeTextToContentEditable(element, text) {
        ...
        var afterContentChanged = function () {
            nextTick()
                ...
                if (needRaiseInputEvent)
                    eventSimulator$5.input(element, text);
        ...
        if (!domUtils$7.isTheSameNode(startNode, endNode)) {
            textSelection$4.deleteSelectionContents(element);
        ...
        if (!startNode || !domUtils$7.isContentEditableElement(startNode) || !domUtils$7.isRenderedNode(startNode))
            return;
        if (!simulateBeforeInput(element, text, browserUtils$6.isChrome || browserUtils$6.isFirefox))
            return;
        beforeContentChanged();
        if (needProcessInput)
            needProcessInput = simulateBeforeInput(element, text, browserUtils$6.isSafari);
        if (needProcessInput) {
    ...
    function _typeTextToTextEditable(element, text) {
        ...
        var textLength = text.length;
        var startSelection = textSelection$4.getSelectionStart(element);
        var endSelection = textSelection$4.getSelectionEnd(element);
        ...
        if (elementMaxLength === null || isNaN(elementMaxLength) || elementMaxLength >= newElementValue.length) {
            // NOTE: B254013
            if (isInputTypeNumber && browserUtils$6.isIOS && elementValue[elementValue.length - 1] === '.') {
                startSelection += 1;
                endSelection += 1;
            }
            domUtils$7.setElementValue(element, newElementValue);
            textSelection$4.select(element, startSelection + textLength, startSelection + textLength);
        }
    ...
    function _typeTextToNonTextEditable(element, text, caretPos) {
        ...
        eventSimulator$5.change(element);
        eventSimulator$5.input(element, text);
    }
    ...
    var browserUtils$5 = hammerhead__default["default"].utils.browser;
    var focusBlurSandbox$1 = hammerhead__default["default"].eventSandbox.focusBlur;
    var Promise$6 = hammerhead__default["default"].Promise;
    ...
    function getDeepActiveElement(currentDocument) {
        ...
        if (activeElement && testCafeCore.domUtils.isIframeElement(activeElement) &&
            nativeMethods$2.contentDocumentGetter.call(activeElement)) {
            try {
                activeElementInIframe = getDeepActiveElement(nativeMethods$2.contentDocumentGetter.call(activeElement));
            }
    ...
    function focusNextElement(element, reverse, skipRadioGroups) {
        return new Promise$6(function (resolve) {
            ...
            if (nextElement)
                focusBlurSandbox$1.focus(nextElement, function () { return resolve(nextElement); });
            else
                resolve();
        });
    }
    function getFocusableElementsFilter(sourceElement, skipRadioGroups) {
        ...
        if (skipRadioGroups) {
            ...
            if (sourceElement.name !== '' && !browserUtils$5.isFirefox)
        ...
        else if (browserUtils$5.isChrome)
    ...
    function filterFocusableElements(elements, sourceElement, skipRadioGroups) {
        if (!isRadioButtonElement(sourceElement))
            return elements;
        if (!skipRadioGroups && !sourceElement.name && !browserUtils$5.isChrome)
    ...
    var browserUtils$4 = hammerhead__default["default"].utils.browser;
    var extend$2 = hammerhead__default["default"].utils.extend;
    var eventSimulator$4 = hammerhead__default["default"].eventSandbox.eventSimulator;
    var KeyPressSimulator = /** @class */ (function () {
        ...
        KeyPressSimulator.prototype._type = function (element, char) {
            ...
            if (elementChanged) {
                ...
                shouldType = (!browserUtils$4.isFirefox || isStoredElementEditable) &&
                    (!browserUtils$4.isWebKit || shouldTypeInWebKit);
            }
            if (shouldType) {
        ...
        KeyPressSimulator.prototype.down = function (modifiersState) {
            ...
            return eventSimulator$4.keydown(this.storedActiveElement, extend$2(eventOptions, modifiersState));
        };
        KeyPressSimulator.prototype.press = function (modifiersState) {
            ...
            if (browserUtils$4.isWebKit && elementChanged) {
            ...
            this._addKeyPropertyToEventOptions(eventOptions);
            var raiseDefault = browserUtils$4.isAndroid || eventSimulator$4.keypress(activeElement, extend$2(eventOptions, modifiersState));
            if (!raiseDefault)
                return raiseDefault;
            ...
            var isSafariWithAutoRaisedClick = browserUtils$4.isSafari &&
                browserUtils$4.compareVersions([browserUtils$4.webkitVersion, '603.1.30']) >= 0;
        ...
        KeyPressSimulator.prototype.up = function (modifiersState) {
            ...
            this._addKeyPropertyToEventOptions(eventOptions);
            var raiseDefault = eventSimulator$4.keyup(getDeepActiveElement(this.topSameDomainDocument), extend$2(eventOptions, modifiersState));
            var activeElement = getDeepActiveElement(this.topSameDomainDocument);
            // NOTE: in some browsers we should emulate click on active input element while pressing "space" key
            var emulateClick = !browserUtils$4.isSafari &&
    ...
    var _a$1;
    var Promise$5 = hammerhead__default["default"].Promise;
    var browserUtils$3 = hammerhead__default["default"].utils.browser;
    var eventSimulator$3 = hammerhead__default["default"].eventSandbox.eventSimulator;
    var elementEditingWatcher$1 = hammerhead__default["default"].eventSandbox.elementEditingWatcher;
    var textSelection$3 = testCafeCore__default["default"].textSelection;
    var eventUtils$2 = testCafeCore__default["default"].eventUtils;
    var domUtils$6 = testCafeCore__default["default"].domUtils;
    var selectElement = testCafeUI__default["default"].selectElement;
    var currentTextarea = null;
    var currentTextareaCursorIndent = null;
    function onTextAreaBlur() {
        currentTextarea = null;
        currentTextareaCursorIndent = null;
        eventUtils$2.unbind(this, 'blur', onTextAreaBlur, true);
    }
    function updateTextAreaIndent(element) {
        if (domUtils$6.isTextAreaElement(element)) {
            if (currentTextarea !== element) {
                eventUtils$2.bind(element, 'blur', onTextAreaBlur, true);
    ...
    function getLineIndentInTextarea(textarea) {
        var inverseSelection = textSelection$3.hasInverseSelection(textarea);
        var textareaValue = domUtils$6.getTextAreaValue(textarea);
        var cursorPosition = inverseSelection ?
            textSelection$3.getSelectionStart(textarea) :
            textSelection$3.getSelectionEnd(textarea);
        if (!textareaValue || !cursorPosition)
            return 0;
        return domUtils$6.getTextareaIndentInLine(textarea, cursorPosition);
    }
    function moveTextAreaCursorUp(element, withSelection) {
        var textareaValue = domUtils$6.getTextAreaValue(element);
        if (!textareaValue)
            return;
        var startPos = textSelection$3.getSelectionStart(element);
        var endPos = textSelection$3.getSelectionEnd(element);
        var hasInverseSelection = textSelection$3.hasInverseSelection(element);
    ...
    function moveTextAreaCursor(element, startPos, endPos, hasInverseSelection, newPosition, withSelection) {
        ...
        textSelection$3.select(element, newStart, newEnd);
    }
    function setElementValue(element, value, position) {
        if (domUtils$6.isInputElement(element) && element.type === 'number') {
            if (value.charAt(0) === '-' && value.charAt(1) === '.')
                value = value.substring(1);
            if (value.charAt(value.length - 1) === '.')
                value = value.substring(0, value.length - 1);
        }
        domUtils$6.setElementValue(element, value);
        textSelection$3.select(element, position, position);
        eventSimulator$3.input(element);
    }
    function submitFormOnEnterPressInInput(form, inputElement) {
        ...
        if (submitButton)
            eventSimulator$3.click(submitButton);
        else if (domUtils$6.blocksImplicitSubmission(inputElement)) {
            var formInputs = form.getElementsByTagName('input');
            var textInputs = [];
            for (i = 0; i < formInputs.length; i++) {
                if (domUtils$6.blocksImplicitSubmission(formInputs[i]))
            ...
            if (textInputs.length === 1 && textInputs[0] === inputElement) {
                ...
                if (isInputValid && eventSimulator$3.submit(form))
                    form.submit();
            }
        }
    }
    ...
    function selectAll(element) {
        if (domUtils$6.isEditableElement(element))
            textSelection$3.select(element);
        return Promise$5.resolve();
    }
    function backspace(element) {
        if (domUtils$6.isTextEditableElementAndEditingAllowed(element)) {
            var startPos = textSelection$3.getSelectionStart(element);
            var endPos = textSelection$3.getSelectionEnd(element);
            var value = domUtils$6.getElementValue(element).replace(/\r\n/g, '\n');
            if (endPos === startPos) {
                if (startPos > 0) {
        ...
        if (domUtils$6.isContentEditableElement(element))
            textSelection$3.deleteSelectionContents(element);
        return Promise$5.resolve();
    }
    ...
    function left(element) {
        ...
        if (domUtils$6.isSelectElement(element))
        ...
        if (domUtils$6.isTextEditableElement(element)) {
            startPosition = textSelection$3.getSelectionStart(element) || 0;
            endPosition = textSelection$3.getSelectionEnd(element);
            var newPosition = startPosition === endPosition ? startPosition - 1 : startPosition;
            textSelection$3.select(element, newPosition, newPosition);
            updateTextAreaIndent(element);
        }
        if (domUtils$6.isContentEditableElement(element)) {
            startPosition = textSelection$3.getSelectionStart(element);
            endPosition = textSelection$3.getSelectionEnd(element);
            // NOTE: we only remove selection
            if (startPosition !== endPosition) {
                var selection = textSelection$3.getSelectionByElement(element);
                var inverseSelection = textSelection$3.hasInverseSelectionContentEditable(element);
                ...
                textSelection$3.selectByNodesAndOffsets(startPos, startPos, true);
            }
        }
        return Promise$5.resolve();
    }
    function right(element) {
        ...
        if (domUtils$6.isTextEditableElement(element)) {
            ...
            if (startPosition === domUtils$6.getElementValue(element).length)
    ...
    function up(element) {
        ...
        if (isRadioButtonNavigationRequired(element))
            return focusAndCheckNextRadioButton(element, true);
        if (browserUtils$3.isWebKit && domUtils$6.isInputElement(element))
            return home(element);
        if (domUtils$6.isTextAreaElement(element))
    ...
    function home(element, withSelection) {
        if (domUtils$6.isTextEditableElement(element)) {
            var startPos = textSelection$3.getSelectionStart(element);
            var endPos = textSelection$3.getSelectionEnd(element);
            var inverseSelection = textSelection$3.hasInverseSelection(element);
            var referencePosition = null;
            var isSingleLineSelection = !domUtils$6.isTextAreaElement(element) ? true :
                domUtils$6.getTextareaLineNumberByPosition(element, startPos) ===
                    domUtils$6.getTextareaLineNumberByPosition(element, endPos);
            if (isSingleLineSelection)
                referencePosition = inverseSelection ? endPos : startPos;
            else
                referencePosition = inverseSelection ? startPos : endPos;
            var valueBeforeCursor = domUtils$6.getElementValue(element).substring(0, referencePosition);
            ...
            if (isSingleLineSelection) {
                ...
                textSelection$3.select(element, newEndPos, newStartPos);
            }
            else if (!inverseSelection)
                textSelection$3.select(element, startPos, newPosition);
            else
                textSelection$3.select(element, endPos, newPosition);
        }
        return Promise$5.resolve();
    }
    function end(element, withSelection) {
        if (domUtils$6.isTextEditableElement(element)) {
            ...
            if (isSingleLineSelection)
                ...
                referencePosition = inverseSelection ? startPos : endPos;
            var valueAsterCursor = domUtils$6.getElementValue(element).substring(referencePosition);
            ...
            if (isSingleLineSelection) {
                ...
                textSelection$3.select(element, newStartPos, newEndPos);
            }
            else if (!inverseSelection)
                textSelection$3.select(element, startPos, newPosition);
            else
    ...
    function shiftLeft(element) {
        if (domUtils$6.isTextEditableElement(element)) {
            var startPos = textSelection$3.getSelectionStart(element);
            var endPos = textSelection$3.getSelectionEnd(element);
            if (startPos === endPos || textSelection$3.hasInverseSelection(element))
                textSelection$3.select(element, endPos, Math.max(startPos - 1, 0));
            else
                textSelection$3.select(element, startPos, Math.max(endPos - 1, 0));
            updateTextAreaIndent(element);
        }
        return Promise$5.resolve();
    }
    function shiftRight(element) {
        if (domUtils$6.isTextEditableElement(element)) {
            var startPos = textSelection$3.getSelectionStart(element);
            var endPos = textSelection$3.getSelectionEnd(element);
            var valueLength = domUtils$6.getElementValue(element).length;
            if (startPos === endPos || !textSelection$3.hasInverseSelection(element))
                textSelection$3.select(element, startPos, Math.min(endPos + 1, valueLength));
            else
                textSelection$3.select(element, endPos, Math.min(startPos + 1, valueLength));
            updateTextAreaIndent(element);
        }
        return Promise$5.resolve();
    }
    ...
    function enter(element) {
        ...
        if (domUtils$6.isInputElement(element)) {
            elementEditingWatcher$1.processElementChanging(element);
            var form = domUtils$6.getParents(element, 'form')[0];
        ...
        else if (domUtils$6.isTextAreaElement(element)) {
            var startPos = textSelection$3.getSelectionStart(element);
            var value = domUtils$6.getTextAreaValue(element);
        ...
        //S173120
        else if (element.tagName && domUtils$6.isAnchorElement(element))
            eventSimulator$3.click(element);
        return Promise$5.resolve();
    }
    function isRadioButtonNavigationRequired(element) {
        return domUtils$6.isRadioButtonElement(element);
    }
    ...
    function focusNextElementOnNavigationButton(element, reverse, skipRadioGroups) {
        ...
        return focusNextElement(element, reverse, skipRadioGroups)
            ...
            if (nextElement && domUtils$6.isTextEditableInput(nextElement))
                textSelection$3.select(nextElement);
            return nextElement;
        });
    }
    ...
    var _a;
    var SHORTCUT_TO_COMMANDS_MAP = (_a = {},
    ...
    var Promise$4 = hammerhead__default["default"].Promise;
    var messageSandbox = hammerhead__default["default"].eventSandbox.message;
    ...
    messageSandbox.on(messageSandbox.SERVICE_MSG_RECEIVED_EVENT, function (e) {
        if (e.message.cmd === PRESS_REQUEST_CMD) {
            hammerhead__default["default"].on(hammerhead__default["default"].EVENTS.beforeUnload, function () { return messageSandbox.sendServiceMsg({ cmd: PRESS_RESPONSE_CMD }, e.source); });
            var pressAutomation = new PressAutomation(e.message.keyCombinations, e.message.options);
            pressAutomation
                .run()
                .then(function () { return messageSandbox.sendServiceMsg({ cmd: PRESS_RESPONSE_CMD }, e.source); });
        }
    });
    var PressAutomation = /** @class */ (function () {
        ...
        PressAutomation.prototype._down = function (keyPressSimulator) {
            ...
            return Promise$4.resolve(keyDownPrevented);
        };
        ...
        PressAutomation.prototype.run = function () {
            ...
            if (!isIframeWindow(window) && activeElementIsIframe && nativeMethods$1.contentWindowGetter.call(activeElement)) {
                var msg = {
                    cmd: PRESS_REQUEST_CMD,
                    keyCombinations: this.keyCombinations,
                    options: this.options,
                };
                return testCafeCore.sendRequestToFrame(msg, PRESS_RESPONSE_CMD, nativeMethods$1.contentWindowGetter.call(activeElement));
            }
    ...
    var extend$1 = hammerhead__default["default"].utils.extend;
    var eventSimulator$2 = hammerhead__default["default"].eventSandbox.eventSimulator;
    var domUtils$5 = testCafeCore__default["default"].domUtils, eventUtils$1 = testCafeCore__default["default"].eventUtils, delay$2 = testCafeCore__default["default"].delay;
    var RClickAutomation = /** @class */ (function (_super) {
        ...
        RClickAutomation.prototype._mousedown = function (eventArgs) {
            ...
            return cursor
                .rightButtonDown()
                .then(function () {
                _this.eventState.activeElementBeforeMouseDown = domUtils$5.getActiveElement();
                _this.eventState.simulateDefaultBehavior = eventSimulator$2.mousedown(eventArgs.element, eventArgs.options);
                return _this._focus(eventArgs);
            });
        };
        ...
        RClickAutomation.prototype._mouseup = function (eventArgs) {
            ...
            return cursor
                .buttonUp()
                .then(function () { return _this._getElementForEvent(eventArgs); })
                .then(function (element) { return eventSimulator$2.mouseup(element, eventArgs.options); });
        };
        RClickAutomation.prototype._contextmenu = function (eventArgs) {
            return this
                ._getElementForEvent(eventArgs)
                .then(function (element) {
                eventSimulator$2.contextmenu(element, eventArgs.options);
                if (!domUtils$5.isElementFocusable(element))
            ...
            return this
                ...
                eventArgs = {
                    ...
                    options: extend$1({
                        ...
                        screenX: devicePoint.x,
                        screenY: devicePoint.y,
                        button: eventUtils$1.BUTTON.right,
                    }, _this.modifiers),
                };
                // NOTE: we should raise mouseup event with 'mouseActionStepDelay' after we trigger
                // mousedown event regardless of how long mousedown event handlers were executing
                return Promise$3.all([delay$2(_this.automationSettings.mouseActionStepDelay), _this._mousedown(eventArgs)]);
            })
    ...
    var browserUtils$2 = hammerhead__default["default"].utils.browser;
    var domUtils$4 = testCafeCore__default["default"].domUtils;
    var positionUtils$3 = testCafeCore__default["default"].positionUtils;
    var styleUtils = testCafeCore__default["default"].styleUtils;
    var contentEditable$4 = testCafeCore__default["default"].contentEditable;
    var arrayUtils = testCafeCore__default["default"].arrayUtils;
    ...
    function ensureRectangleInsideElement(element, rect) {
        ...
        if (!domUtils$4.isTextAreaElement(element)) {
    ...
    function getSelectionRectangleInContentEditableElement(element, position) {
        var range = domUtils$4.findDocument(element).createRange();
        var selectionPosition = contentEditable$4.calculateNodeAndOffsetByPosition(element, position);
    ...
    function getSelectionRectangle(element, position) {
        ...
        var valueLength = domUtils$4.getElementValue(element).length;
        try {
            var range = document.createRange(); //B254723
            range.setStart(hammerhead__default["default"].nativeMethods.nodeFirstChildGetter.call(fakeDiv), Math.min(position, valueLength));
            // NOTE: The range.getClientRects function returns wrong result if range length is 0 in Safari 11
            range.setEnd(hammerhead__default["default"].nativeMethods.nodeFirstChildGetter.call(fakeDiv), Math.min(position + 1, valueLength + 1));
            if (domUtils$4.isTextAreaElement(element)) {
    ...
    function createFakeDiv(element) {
        ...
        arrayUtils.forEach(MODIFIERS_LIST, function (modifier) {
            fakeDivCssStyles += "".concat(modifier, ":").concat(styleUtils.get(element, modifier), ";");
        });
        ...
        hammerhead__default["default"].nativeMethods.nodeTextContentSetter.call(fakeDiv, domUtils$4.getElementValue(element) + ' ');
        body.appendChild(fakeDiv);
        return fakeDiv;
    }
    function getPositionCoordinates(element, position) {
        var rect = null;
        if (domUtils$4.isContentEditableElement(element))
    ...
    function getSelectionCoordinatesByPosition(element, position) {
        var isTextEditable = domUtils$4.isTextEditableElement(element);
        var isContentEditable = domUtils$4.isContentEditableElement(element);
        var hasText = isTextEditable && domUtils$4.getElementValue(element).length > 0 ||
            isContentEditable && contentEditable$4.getContentEditableValue(element).length;
        if (!hasText)
    ...
    function scrollEditableElementByPoint(element, point) {
        if (!domUtils$4.isEditableElement(element))
            return;
        var isTextarea = domUtils$4.isTextAreaElement(element);
        var isInputElement = domUtils$4.isInputElement(element);
        // NOTE: we don't need to scroll input elements in Mozilla
        // because it happens automatically on selection setting
        if (isInputElement && browserUtils$2.isFirefox)
            return;
        var elementOffset = positionUtils$3.getOffsetPosition(element);
        var elementBorders = styleUtils.getBordersWidth(element);
    ...
    function excludeElementScroll(element, point) {
        var isTextEditable = domUtils$4.isTextEditableElement(element);
        var isInputElement = domUtils$4.isInputElement(element);
        if (!(isTextEditable || domUtils$4.isContentEditableElement(element)))
            return point;
        var elementOffset = positionUtils$3.getOffsetPosition(element);
        var elementBorders = styleUtils.getBordersWidth(element);
        var elementScroll = styleUtils.getElementScroll(element);
        ...
        if (isInputElement && isTextEditable && browserUtils$2.isFirefox) {
            return {
    ...
    var featureDetection = hammerhead__default["default"].utils.featureDetection;
    var eventSimulator$1 = hammerhead__default["default"].eventSandbox.eventSimulator;
    var focusBlurSandbox = hammerhead__default["default"].eventSandbox.focusBlur;
    var contentEditable$3 = testCafeCore__default["default"].contentEditable;
    var domUtils$3 = testCafeCore__default["default"].domUtils;
    var positionUtils$2 = testCafeCore__default["default"].positionUtils;
    var eventUtils = testCafeCore__default["default"].eventUtils;
    var delay$1 = testCafeCore__default["default"].delay;
    var SelectBaseAutomation = /** @class */ (function (_super) {
        ...
        SelectBaseAutomation.prototype._calculateEventArguments = function () {
            var _this = this;
            var clientPoint = positionUtils$2.offsetToClientCoords(this.clientPoint);
            return getElementFromPoint(clientPoint)
                .then(function (element) {
                if (!element) {
                    throw new ActionElementIsInvisibleError(null, {
                        reason: positionUtils$2.getElOutsideBoundsReason(_this.element),
                    });
                }
                return {
                    element: element,
        ...
        SelectBaseAutomation.prototype._mousedown = function () {
            ...
            return cursor
                ...
                // NOTE: In WebKit, the mousedown event opens the select element's dropdown;
                // therefore, we should prevent mousedown and hide the dropdown (B236416).
                var needCloseSelectDropDown = browserUtils$1.isWebKit && domUtils$3.isSelectElement(_this.element);
                if (needCloseSelectDropDown)
                    _this._bindMousedownHandler();
                _this.eventState.simulateDefaultBehavior = eventSimulator$1[_this.downEvent](_this.eventArgs.element, _this.eventArgs.options);
        ...
        SelectBaseAutomation.prototype._focus = function () {
            ...
            return new Promise$2(function (resolve) {
                // NOTE: If the target element is a child of a contentEditable element, we need to call focus for its parent
                var elementForFocus = domUtils$3.isContentEditableElement(_this.element) ?
        ...
        SelectBaseAutomation.prototype._mouseup = function () {
            ...
            return cursor
                ...
                .then(function (args) {
                _this.eventArgs = args;
                eventSimulator$1[_this.upEvent](_this.eventArgs.element, _this.eventArgs.options);
            });
        };
    ...
    var textSelection$2 = testCafeCore__default["default"].textSelection;
    var domUtils$2 = testCafeCore__default["default"].domUtils;
    ...
    var SelectTextAutomation = /** @class */ (function (_super) {
        ...
        SelectTextAutomation.prototype._calculateAbsoluteStartPoint = function () {
            ...
            return point || positionUtils$1.findCenter(this.element);
        };
        SelectTextAutomation.prototype._calculateAbsoluteEndPoint = function () {
            ...
            if (domUtils$2.isContentEditableElement(this.element))
                return getLastVisibleSelectionPosition(this.element, this.startPos, this.endPos);
            return positionUtils$1.findCenter(this.element);
        };
        SelectTextAutomation.prototype._setSelection = function () {
            var isTextEditable = domUtils$2.isTextEditableElement(this.element);
            var isContentEditable = domUtils$2.isContentEditableElement(this.element);
            if (!(isTextEditable || isContentEditable) || this.eventState.simulateDefaultBehavior === false)
                return;
            textSelection$2.select(this.element, this.startPos, this.endPos);
        };
    ...
    var textSelection$1 = testCafeCore__default["default"].textSelection;
    var contentEditable$2 = testCafeCore__default["default"].contentEditable;
    var positionUtils = testCafeCore__default["default"].positionUtils;
    var SelectEditableContentAutomation = /** @class */ (function (_super) {
        ...
        function SelectEditableContentAutomation(startNode, endNode, actionOptions) {
            var _this = _super.call(this, contentEditable$2.getNearestCommonAncestor(startNode, endNode), actionOptions) || this;
            var startOffset = contentEditable$2.getFirstVisiblePosition(startNode);
            var endOffset = contentEditable$2.getLastVisiblePosition(endNode);
            var startPos = { node: startNode, offset: startOffset };
            var endPos = { node: endNode, offset: endOffset };
            var startPosition = contentEditable$2.calculatePositionByNodeAndOffset(_this.element, startPos);
            var endPosition = contentEditable$2.calculatePositionByNodeAndOffset(_this.element, endPos);
            if (startPosition > endPosition) {
                startOffset = contentEditable$2.getLastVisiblePosition(startNode);
                endOffset = contentEditable$2.getFirstVisiblePosition(endNode);
            }
            ...
            startPos = contentEditable$2.calculateNodeAndOffsetByPosition(startNode, startOffset);
            endPos = contentEditable$2.calculateNodeAndOffsetByPosition(endNode, endOffset);
        ...
        SelectEditableContentAutomation.prototype._setSelection = function () {
            ...
            textSelection$1.selectByNodesAndOffsets(startPos, endPos, true);
        };
        return SelectEditableContentAutomation;
    }(SelectBaseAutomation));

    var Promise$1 = hammerhead__default["default"].Promise;
    var extend = hammerhead__default["default"].utils.extend;
    ...
    var elementEditingWatcher = hammerhead__default["default"].eventSandbox.elementEditingWatcher;
    var domUtils$1 = testCafeCore__default["default"].domUtils;
    var promiseUtils = testCafeCore__default["default"].promiseUtils;
    var contentEditable$1 = testCafeCore__default["default"].contentEditable;
    var textSelection = testCafeCore__default["default"].textSelection;
    var delay = testCafeCore__default["default"].delay;
    var SPECIAL_KEYS = testCafeCore__default["default"].KEY_MAPS.specialKeys;
    var TypeAutomation = /** @class */ (function () {
        ...
        TypeAutomation.findTextEditableChild = function (element) {
            ...
            if (!domUtils$1.isEditableElement(element)) {
                var allChildren = element.querySelectorAll('*');
                for (var i = 0; i < allChildren.length; i++) {
                    if (domUtils$1.isTextEditableElementAndEditingAllowed(allChildren[i])) {
        ...
        TypeAutomation.prototype._calculateEventArguments = function (isPressEvent) {
            var activeElement = domUtils$1.getActiveElement();
            var isContentEditable = domUtils$1.isContentEditableElement(this.element);
        ...
        TypeAutomation.prototype._calculateTargetElement = function () {
            ...
            if (isContentEditable) {
                if (activeElement !== contentEditable$1.findContentEditableParent(this.element)) {
        ...
        TypeAutomation.prototype._click = function (useStrictElementCheck) {
            var _this = this;
            var activeElement = domUtils$1.getActiveElement();
            var isTextEditable = domUtils$1.isTextEditableElementAndEditingAllowed(this.element);
            var isContentEditable = domUtils$1.isContentEditableElement(this.element);
        ...
        TypeAutomation.prototype._type = function () {
            ...
            var isContentEditable = domUtils$1.isContentEditableElement(this.element);
            if (this.replace) {
                if (domUtils$1.isTextEditableElementAndEditingAllowed(this.element))
        ...
        TypeAutomation.prototype._calculateCDPEventSequence = function () {
            ...
            for (var _i = 0, _a = this.typingText; _i < _a.length; _i++) {
                ...
                var simulatedKeyInfo = extend({ key: currentKey }, keyInfo);
        ...
        TypeAutomation.prototype._canUseNativeAutomationInput = function () {
            ...
            if (!domUtils$1.isTextEditableElement(this.element)
                && domUtils$1.isInputElement(this.element)
                || domUtils$1.isContentEditableElement(this.element))
                return false;
            return true;
        };
        ...
        TypeAutomation.prototype._typingStep = function () {
            ...
            this.ignoreChangeEvent = domUtils$1.getElementValue(this.element) === elementEditingWatcher.getElementSavedValue(this.element);
        ...
        TypeAutomation.prototype._keyup = function () {
            ...
            this.eventArgs = this._calculateEventArguments();
            var isTextEditableElement = domUtils$1.isTextEditableElement(this.element);
            var isContentEditable = domUtils$1.isContentEditableElement(this.element);
            ...
            return Promise$1
                ...
                .then(function () {
                eventSimulator.keyup(_this.eventArgs.element, _this.eventArgs.options);
        ...
        TypeAutomation.prototype._typeChar = function (element) {
            ...
            var isInputTypeNumber = domUtils$1.isInputElement(element) && element.type === 'number';
            if (isInputTypeNumber) {
                var selectionStart = textSelection.getSelectionStart(element);
                var valueLength = domUtils$1.getInputValue(element).length;
    ...
    var domUtils = testCafeCore__default["default"].domUtils;
    var contentEditable = testCafeCore__default["default"].contentEditable;
    ...
    nativeMethods.objectDefineProperty(window, '%testCafeAutomation%', { configurable: true, value: exports$1 });
    // eslint-disable-next-line no-undef
    hammerhead__default["default"].on(evalIframeScript, function (e) { return initTestCafeAutomation(nativeMethods.contentWindowGetter.call(e.iframe), true); });
