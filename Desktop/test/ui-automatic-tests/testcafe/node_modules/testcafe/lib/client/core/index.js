...
(function () {
    ...
    var Promise__default = /*#__PURE__*/_interopDefaultLegacy(Promise$6);
    ...
    var KEY_MAPS = {
        ...
        symbolCharCodeToKeyCode: {
            ...
            39: 222,
            44: 188,
            45: browserUtils$3.isFirefox ? 173 : 189,
            46: 190,
            47: 191, // /
        },
        symbolKeysCharCodes: {
    ...
    function delay$1 (ms) {
        return new Promise$5(function (resolve) { return nativeMethods$7.setTimeout.call(window, resolve, ms); });
    }
    ...
    ***************************************************************************** */
    ...
    var HammerheadClientRequestEmitter = /** @class */ (function (_super) {
        ...
        function HammerheadClientRequestEmitter() {
            ...
            _this._addHammerheadListener(hammerhead__default["default"].EVENTS.beforeXhrSend, function (_a) {
                var xhr = _a.xhr;
                return _this.emit(REQUEST_SEND_EVENT, xhr);
            });
            _this._addHammerheadListener(hammerhead__default["default"].EVENTS.xhrCompleted, function (_a) {
                var xhr = _a.xhr;
                return _this.emit(REQUEST_COMPLETED_EVENT, xhr);
            });
            _this._addHammerheadListener(hammerhead__default["default"].EVENTS.xhrError, function (_a) {
                var xhr = _a.xhr;
                return _this.emit(REQUEST_ERROR_EVENT, xhr);
            });
            _this._addHammerheadListener(hammerhead__default["default"].EVENTS.fetchSent, function (fetch) {
        ...
        HammerheadClientRequestEmitter.prototype._addHammerheadListener = function (evt, listener) {
            hammerhead__default["default"].on(evt, listener);
        ...
        HammerheadClientRequestEmitter.prototype.offAll = function () {
            ...
            for (var _i = 0, _a = this._hammerheadListenersInfo; _i < _a.length; _i++) {
                var info = _a[_i];
                hammerhead__default["default"].off.call(hammerhead__default["default"], info.evt, info.listener);
            }
        };
    ...
    var HammerheadScriptExecutionEmitter = /** @class */ (function (_super) {
        ...
        function HammerheadScriptExecutionEmitter() {
            ...
            hammerhead__default["default"].on(hammerhead__default["default"].EVENTS.scriptElementAdded, _this._scriptElementAddedListener);
            return _this;
        }
        HammerheadScriptExecutionEmitter.prototype._onScriptElementAdded = function (script) {
            var _this = this;
            var scriptSrc = nativeMethods$6.scriptSrcGetter.call(script);
            if (scriptSrc === void 0 || scriptSrc === '')
                return;
            this.emit(SCRIPT_ADDED, script);
            var done = function () {
                nativeMethods$6.removeEventListener.call(script, 'load', done);
                nativeMethods$6.removeEventListener.call(script, 'error', done);
                _this.emit(SCRIPT_LOADED_OR_FAILED, script);
            };
            nativeMethods$6.addEventListener.call(script, 'load', done);
            nativeMethods$6.addEventListener.call(script, 'error', done);
        };
        ...
        HammerheadScriptExecutionEmitter.prototype.offAll = function () {
            _super.prototype.offAll.call(this);
            hammerhead__default["default"].off(hammerhead__default["default"].EVENTS.scriptElementAdded, this._onScriptElementAdded);
        };
    ...
    var getElementStyleProperty = hammerhead__default["default"].utils.style.get;
    var getActiveElement = hammerhead__default["default"].utils.dom.getActiveElement;
    var findDocument = hammerhead__default["default"].utils.dom.findDocument;
    var find = hammerhead__default["default"].utils.dom.find;
    var isElementInDocument = hammerhead__default["default"].utils.dom.isElementInDocument;
    ...
    var isCrossDomainWindows = hammerhead__default["default"].utils.dom.isCrossDomainWindows;
    var getSelectParent = hammerhead__default["default"].utils.dom.getSelectParent;
    var getChildVisibleIndex = hammerhead__default["default"].utils.dom.getChildVisibleIndex;
    var getSelectVisibleChildren = hammerhead__default["default"].utils.dom.getSelectVisibleChildren;
    var isElementNode = hammerhead__default["default"].utils.dom.isElementNode;
    var isTextNode = hammerhead__default["default"].utils.dom.isTextNode;
    var isRenderedNode = hammerhead__default["default"].utils.dom.isRenderedNode;
    var isIframeElement = hammerhead__default["default"].utils.dom.isIframeElement;
    var isInputElement = hammerhead__default["default"].utils.dom.isInputElement;
    var isButtonElement = hammerhead__default["default"].utils.dom.isButtonElement;
    var isFileInput = hammerhead__default["default"].utils.dom.isFileInput;
    var isTextAreaElement = hammerhead__default["default"].utils.dom.isTextAreaElement;
    var isAnchorElement = hammerhead__default["default"].utils.dom.isAnchorElement;
    var isImgElement = hammerhead__default["default"].utils.dom.isImgElement;
    var isFormElement = hammerhead__default["default"].utils.dom.isFormElement;
    var isLabelElement = hammerhead__default["default"].utils.dom.isLabelElement;
    var isSelectElement = hammerhead__default["default"].utils.dom.isSelectElement;
    var isRadioButtonElement = hammerhead__default["default"].utils.dom.isRadioButtonElement;
    var isColorInputElement = hammerhead__default["default"].utils.dom.isColorInputElement;
    var isCheckboxElement = hammerhead__default["default"].utils.dom.isCheckboxElement;
    var isOptionElement = hammerhead__default["default"].utils.dom.isOptionElement;
    var isSVGElement = hammerhead__default["default"].utils.dom.isSVGElement;
    ...
    var isDocument = hammerhead__default["default"].utils.dom.isDocument;
    var isTextEditableInput = hammerhead__default["default"].utils.dom.isTextEditableInput;
    var isTextEditableElement = hammerhead__default["default"].utils.dom.isTextEditableElement;
    var isTextEditableElementAndEditingAllowed = hammerhead__default["default"].utils.dom.isTextEditableElementAndEditingAllowed;
    var isContentEditableElement = hammerhead__default["default"].utils.dom.isContentEditableElement;
    var isDomElement = hammerhead__default["default"].utils.dom.isDomElement;
    var isShadowUIElement = hammerhead__default["default"].utils.dom.isShadowUIElement;
    var isShadowRoot = hammerhead__default["default"].utils.dom.isShadowRoot;
    var isElementFocusable = hammerhead__default["default"].utils.dom.isElementFocusable;
    var isHammerheadAttr = hammerhead__default["default"].utils.dom.isHammerheadAttr;
    var isElementReadOnly = hammerhead__default["default"].utils.dom.isElementReadOnly;
    ...
    var getTopSameDomainWindow = hammerhead__default["default"].utils.dom.getTopSameDomainWindow;
    var getParentExceptShadowRoot = hammerhead__default["default"].utils.dom.getParentExceptShadowRoot;
    function canFocus(element, parent, tabIndex) {
        var activeElement = null;
        if (parent.nodeType === Node.DOCUMENT_NODE)
            activeElement = nativeMethods$5.documentActiveElementGetter.call(parent);
        ...
        if (getElementStyleProperty(element, 'display') === 'none' || getElementStyleProperty(element, 'visibility') === 'hidden')
            return false;
        if (browserUtils$2.isAndroid && isOptionElement(element))
            return false;
    ...
    function buildFocusableTree(parent, sort) {
        ...
        if (isIframeElement(parent))
            parent = nativeMethods$5.contentDocumentGetter.call(parent);
    ...
    function getTabIndexAttributeIntValue(el) {
        var tabIndex = nativeMethods$5.getAttribute.call(el, 'tabindex');
        if (tabIndex !== null) {
    ...
    function isElementContainsNode(parentElement, childNode) {
        if (isTheSameNode(childNode, parentElement))
            return true;
        var childNodes = nativeMethods$5.nodeChildNodesGetter.call(parentElement);
    ...
    function isOptionGroupElement(element) {
        return hammerhead__default["default"].utils.dom.instanceToString(element) === '[object HTMLOptGroupElement]';
    }
    ...
    function isIFrameWindowInDOM(win) {
        ...
        if ((browserUtils$2.isFirefox || browserUtils$2.isWebKit) && win.top !== win && !frameElement)
            return true;
        return !!(frameElement && nativeMethods$5.contentDocumentGetter.call(frameElement));
    }
    ...
    function findIframeByWindow(iframeWindow) {
        ...
        for (var i = 0; i < iframes.length; i++) {
            if (nativeMethods$5.contentWindowGetter.call(iframes[i]) === iframeWindow)
                return iframes[i];
        }
        return null;
    }
    ...
    function getCommonAncestor(element1, element2) {
        ...
        while (commonAncestor) {
            ...
            commonAncestor = nativeMethods$5.nodeParentNodeGetter.call(commonAncestor);
        }
        return commonAncestor;
    }
    function getChildrenLength(children) {
        return nativeMethods$5.htmlCollectionLengthGetter.call(children);
    }
    function getChildNodesLength(childNodes) {
        return nativeMethods$5.nodeListLengthGetter.call(childNodes);
    }
    function getInputValue(input) {
        return nativeMethods$5.inputValueGetter.call(input);
    }
    function getTextAreaValue(textArea) {
        return nativeMethods$5.textAreaValueGetter.call(textArea);
    }
    function setInputValue(input, value) {
        return nativeMethods$5.inputValueSetter.call(input, value);
    }
    function setTextAreaValue(textArea, value) {
        return nativeMethods$5.textAreaValueSetter.call(textArea, value);
    }
    ...
    var BUTTON = hammerhead__default["default"].utils.event.BUTTON;
    var BUTTONS_PARAMETER = hammerhead__default["default"].utils.event.BUTTONS_PARAMETER;
    var DOM_EVENTS = hammerhead__default["default"].utils.event.DOM_EVENTS;
    var WHICH_PARAMETER = hammerhead__default["default"].utils.event.WHICH_PARAMETER;
    var preventDefault = hammerhead__default["default"].utils.event.preventDefault;
    function bind(el, event, handler, useCapture) {
        nativeMethods$4.addEventListener.call(el, event, handler, useCapture);
    }
    function unbind(el, event, handler, useCapture) {
        nativeMethods$4.removeEventListener.call(el, event, handler, useCapture);
    }
    // Document ready
    var waitForDomContentLoaded = function () {
        ...
        function createPromiseResolver(resolveHandler) {
            return new Promise$4(function (resolve) { return resolveHandlers.push(function () { return resolve(resolveHandler()); }); });
        }
        var isReady = false;
        function ready() {
            if (isReady)
                return;
            if (!document.body) {
                nativeMethods$4.setTimeout.call(window, ready, 1);
                return;
            }
            isReady = true;
        ...
        if (document.readyState === 'complete')
            nativeMethods$4.setTimeout.call(window, onContentLoaded, 1);
        else
            bind(document, 'DOMContentLoaded', onContentLoaded);
        return { then: function (handler) { return createPromiseResolver(handler); } };
    };
    var waitForWindowLoad = function () { return new Promise$4(function (resolve) { return bind(window, 'load', resolve); }); };
    function documentReady(pageLoadTimeout) {
        if (pageLoadTimeout === void 0) { pageLoadTimeout = 0; }
        return waitForDomContentLoaded()
            .then(function () {
            if (!listeners$2.getEventListeners(window, 'load').length)
                return null;
            return Promise$4.race([waitForWindowLoad(), delay$1(pageLoadTimeout)]);
        });
    }
    ...
    function waitForFileDownload() {
        return delay$1(FILE_DOWNLOAD_CHECK_DELAY)
            ...
            if (!fileDownloadingHandled)
                return new Promise$3(function () { }); // eslint-disable-line @typescript-eslint/no-empty-function
        });
    }
    // API
    function init() {
        hammerhead__default["default"].on(hammerhead__default["default"].EVENTS.beforeUnload, onBeforeUnload);
    ...
    function watchForPageNavigationTriggers() {
        ...
        hammerhead__default["default"].on(hammerhead__default["default"].EVENTS.pageNavigationTriggered, pageNavigationTriggeredListener);
    }
    function wait(timeout) {
        ...
        if (pageNavigationTriggeredListener) {
            hammerhead__default["default"].off(hammerhead__default["default"].EVENTS.pageNavigationTriggered, pageNavigationTriggeredListener);
            pageNavigationTriggeredListener = null;
        }
        var waitForUnloadingPromise = delay$1(timeout)
            .then(function () {
            if (!unloading)
                return void 0;
        ...
        var watchdog = delay$1(MAX_UNLOADING_TIMEOUT)
            .then(function () {
            unloading = false;
        });
    ...
    function inherit(Child, Parent) {
        ...
        hammerhead__default["default"].utils.extend(Child.prototype, new Func());
    ...
    var styleUtils = hammerhead__default["default"].utils.style;
    var getBordersWidth = hammerhead__default["default"].utils.style.getBordersWidth;
    var getComputedStyle = hammerhead__default["default"].utils.style.getComputedStyle;
    var getElementMargin = hammerhead__default["default"].utils.style.getElementMargin;
    ...
    var getOptionHeight = hammerhead__default["default"].utils.style.getOptionHeight;
    var getSelectElementSize = hammerhead__default["default"].utils.style.getSelectElementSize;
    var isElementVisible$1 = hammerhead__default["default"].utils.style.isElementVisible;
    var isSelectVisibleChild = hammerhead__default["default"].utils.style.isVisibleChild;
    ...
    var browserUtils$1 = hammerhead.utils.browser;
    ...
    function checkBrowserHotkey(e) {
        ...
        return e.shiftKey && e.ctrlKey || (e.altKey || e.metaKey) && browserUtils$1.isMacPlatform || e.keyCode === F12_KEY_CODE;
    }
    ...
    var shadowUI = hammerhead__default["default"].shadowUI;
    ...
    var SelectController = /** @class */ (function () {
        ...
        SelectController.prototype._createOption = function (realOption, parent) {
            ...
            nativeMethods$3.nodeTextContentSetter.call(option, text);
        ...
        SelectController.prototype._createGroup = function (realGroup, parent) {
            ...
            nativeMethods$3.nodeTextContentSetter.call(group, realGroup.label || ' ');
    ...
    function stringifyElement(element) {
        if (!element)
            return '';
        var emptyElement = nativeMethods$2.cloneNode.call(element);
        var outerHtml = htmlUtils.cleanUpHtml(nativeMethods$2.elementOuterHTMLGetter.call(emptyElement));
        var text = truncateString(nativeMethods$2.nodeTextContentGetter.call(element), MAX_TEXT_CONTENT_LENGTH);
        var children = nativeMethods$2.elementChildrenGetter.call(element);
        if (nativeMethods$2.htmlCollectionLengthGetter.call(children) > 0)
    ...
    function getOwnFirstVisibleTextNode(el) {
        ...
        if (!childrenLength && isVisibleTextNode(el))
            return el;
        return find$1(children, function (node) { return isVisibleTextNode(node); });
    }
    function getOwnFirstVisibleNode(el) {
        var cildNodes = hammerhead.nativeMethods.nodeChildNodesGetter.call(el);
        return find$1(cildNodes, function (node) { return isVisibleTextNode(node) ||
    ...
    function isVisibleNode(node) {
        return isTextNode(node) || isElementNode(node) && isElementVisible$1(node);
    }
    ...
    function findContentEditableParent(element) {
        ...
        return find$1(elParents, function (parent) { return hasContentEditableAttr(parent) &&
    ...
    function getSelectedPositionInParentByOffset(node, offset) {
        ...
        if (isShadowUIElement(node) || !currentNode)
    ...
    function getSelectionStart$1(el, selection, inverseSelection) {
    ...
    function getSelectionEnd$1(el, selection, inverseSelection) {
    ...
    function getSelection(el, selection, inverseSelection) {
        return {
            startPos: getSelectionStart$1(el, selection, inverseSelection),
            endPos: getSelectionEnd$1(el, selection, inverseSelection),
        };
    }
    function getSelectionStartPosition(el, selection, inverseSelection) {
        var correctedSelectionStart = getSelectionStart$1(el, selection, inverseSelection);
    ...
    function getSelectionEndPosition(el, selection, inverseSelection) {
        var correctedSelectionEnd = getSelectionEnd$1(el, selection, inverseSelection);
    ...
    function getElementOffset(target) {
        ...
        var firstBreakElement = find$1(childNodes, function (node, index) {
            offset = index;
    ...
    var selectionSandbox = hammerhead__default["default"].eventSandbox.selection;
    ...
    function waitFor (fn, delay, timeout) {
        return new Promise$1(function (resolve, reject) {
            ...
            var intervalId = nativeMethods$1.setInterval.call(window, function () {
                result = fn();
                if (result) {
                    nativeMethods$1.clearInterval.call(window, intervalId);
                    nativeMethods$1.clearTimeout.call(window, timeoutId);
                    resolve(result);
                }
            }, delay);
            var timeoutId = nativeMethods$1.setTimeout.call(window, function () {
                nativeMethods$1.clearInterval.call(window, intervalId);
                reject();
            }, timeout);
        });
    ...
    function getTimeLimitedPromise (promise, ms) {
        return hammerhead.Promise.race([promise, delay$1(ms).then(function () { return hammerhead.Promise.reject(new TimeLimitedPromiseTimeoutExpiredError()); })]);
    }
    ...
    var trim = hammerhead__default["default"].utils.trim;
    ...
    //Utils
    function delay(ms) {
        return new Promise__default["default"](function (resolve) { return setTimeout(resolve, ms); });
    }
    ...
    function sendXHR(url, createXHR, _a) {
        ...
        return new Promise__default["default"](function (resolve, reject) {
            var xhr = createXHR();
    ...
    nativeMethods.objectDefineProperty(window, '%testCafeCore%', { configurable: true, value: exports$1 });
    // NOTE: initTestCafeCore defined in wrapper template
    /* global initTestCafeCore */
    hammerhead__default["default"].on(evalIframeScript, function (e) { return initTestCafeCore(nativeMethods.contentWindowGetter.call(e.iframe), true); });
    ...
    messageSandbox.on(messageSandbox.SERVICE_MSG_RECEIVED_EVENT, function (e) {
        ...
        scroll.run()
            .then(function () { return messageSandbox.sendServiceMsg({ cmd: ScrollAutomation.SCROLL_RESPONSE_CMD }, e.source); });
    });
